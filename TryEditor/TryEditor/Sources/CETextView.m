...

{
    ...
    if (self) {
        ...
        // 挿入すると行間がズレる」問題が生じるため、CELayoutManager および ATSTypesetter で制御している）
...

{
    ...
    [[ColorCodePanelController sharedController] showWindow:sender];
    [[ColorCodePanelController sharedController] setColorWithCode:curStr];
}
...

{
    ...
    // BaseDocument > writeWithBackupToFile:ofType:saveOperation:でも同様の処理を行っている (2008.06.01)
