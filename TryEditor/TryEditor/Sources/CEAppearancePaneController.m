...
@interface AppearancePaneController () <NSTableViewDelegate, NSTableViewDataSource>
...
@implementation AppearancePaneController
...
//------------------------------------------------------
{
    ...
    [savePanel setAllowedFileTypes:@[@"trytheme"]];
...
//------------------------------------------------------
{
    ...
    [openPanel setAllowedFileTypes:@[@"trytheme"]];
