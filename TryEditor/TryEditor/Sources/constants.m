...
// Error domain
NSString *const CEErrorDomain = @"com.romanysoft.app.macos.TryEditor.ErrorDomain";
...
NSString *const BaseDocumentDidFinishOpenNotification = @"BaseDocumentDidFinishOpenNotification";
...
// Online URLs
NSString *const k_webSiteURL = @"http://www.romanysoft.com/app/TryEditor";
NSString *const k_issueTrackerURL = @"http://www.romanysoft.com/app/TryEditor/issues";
NSString *const k_onlineHelpURL = @"http://www.romanysoft.com/app/TryEditor/help";
...
CGFloat const k_lineNumPadding = 5.0;
CGFloat const k_lineNumFontDescender = -2.1;
NSString *const k_navigationBarFontName = @"System";
...
CGFloat const k_defaultLineHeightMultiple = 1.2;
...
NSUInteger const k_maxEncodingScanLength = 20000;
...
CFStringEncodings const k_CFStringEncodingList[] = {
    ...
    // Encodings available 10.4 and later (TryEditor added in 0.8.0)
