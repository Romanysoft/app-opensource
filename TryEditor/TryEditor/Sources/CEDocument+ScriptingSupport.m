...
#import "BaseDocument+ScriptingSupport.h"
#import "CommonUtils.h"


@implementation BaseDocument (ScriptingSupport)
...

{
    ...
    NSStringEncoding encoding = [CommonUtils encodingFromName:encodingName];
    BOOL success = NO;
