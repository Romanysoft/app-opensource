...
#import "AppearancePaneController.h"
...
@property (nonatomic) AppearancePaneController *appearancePaneController;
...

{
    ...
    if (self) {
        ...
        [self setAppearancePaneController:[[AppearancePaneController alloc] initWithNibName:@"AppearancePane" bundle:nil]];
...
//------------------------------------------------------
{
    ...
    NSString* bookName = [NSString stringWithFormat:@"%@/Preference#%@",k_onlineHelpURL,k_helpPrefAnchors[[sender tag]]];
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:bookName]];
}
