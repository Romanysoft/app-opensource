...

{
    if (self = [super init]) {
        ...
        _spaceChar = [CommonUtils invisibleSpaceChar:[defaults integerForKey:k_key_invisibleSpace]];
        _tabChar = [CommonUtils invisibleTabChar:[defaults integerForKey:k_key_invisibleTab]];
        _newLineChar = [CommonUtils invisibleNewLineChar:[defaults integerForKey:k_key_invisibleNewLine]];
        _fullwidthSpaceChar = [CommonUtils invisibleFullwidthSpaceChar:[defaults integerForKey:k_key_invisibleFullwidthSpace]];
        ...
        [self setTypesetter:[ATSTypesetter sharedSystemTypesetter]];
    }
    return self;
}
